import { FiHome, FiUser, FiBell, FiInbox, FiClock, FiMessageSquare } from 'react-icons/fi';
    ...
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white shadow-lg border-t border-gray-200" aria-label="Mobile navigation">
      <section className="flex justify-around">
        ...
        <button 
          ...
          className={`group flex flex-col items-center justify-center p-3 relative ${location.pathname === '/reviewer/notifications' ? 'text-blue-600' : 'text-gray-600'} hover:bg-blue-50 rounded-lg transition-all duration-200`}
