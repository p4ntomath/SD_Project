    ...
    <article className="bg-white rounded-xl shadow-lg p-6">
      <header className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-4">
          <figure className="p-3 bg-blue-50 rounded-lg">
            ...
            <div className="overflow-y-auto max-h-[300px] pr-2 -mr-2 no-scrollbar">
              {folders.length === 0 ? (
                <section className="text-center py-12">
                  <figure className="mx-auto w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mb-4">
                  ...
                  {folders.map((folder) => (
                    ...
                    >
                      <header className="flex items-center gap-4 mb-4">
                        <figure className="p-3 bg-blue-50 rounded-lg group-hover:bg-blue-100 transition-colors">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                          </svg>
                        </figure>
                      ...
                      <section className="space-y-2">
                        <div className="text-xs text-gray-500">
                          ...
                          <meter
                            className="w-full h-1.5 bg-gray-100 rounded-full overflow-hidden mt-1"
                            value={(folder.size || 0)}
                            max={100 * 1024 * 1024}
                          >
                            <div 
                          ...
                          {folder.files && folder.files.length > 0 ? (
                            <ul>
                              {folder.files.map((file) => (
                                <li key={file.id}>
                                  <article className="flex items-center justify-between p-2 rounded-lg hover:bg-gray-100 transition-colors">
                            ...
                            <figure className="flex flex-col items-center justify-center py-6 text-center">
                              <svg className="h-12 w-12 text-gray-400 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                              </svg>
                              <figcaption className="text-sm text-gray-500">This folder is empty</figcaption>
                            </figure>
                          )}
                        </section>
                      </section>
                      ...
                      {checkPermission(project, 'canUploadFiles') && (
                        <footer className="mt-4 flex items-center justify-between pt-4 border-t border-gray-100">
                          <button
                            onClick={() => {
