    ...
    <main className="min-h-screen bg-gray-50/90 backdrop-blur-xl">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <header className="mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">View and manage research projects and funding</p>
        </header>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <article className="bg-white rounded-lg shadow p-6">
            <header className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-gray-800">Project Stats</h2>
            </header>
          ...
          <article className="bg-white rounded-lg shadow p-6">
            ...
            <section className="space-y-4">
              {/* Content for recent activities, if any */}
            </section>
          </article>
        </section>
