              ...
              <>
                {projects.length > 0 ? (
                  <section ref={projectsRef} className="grid grid-cols-1 gap-6">
                    ...
                    <section key={index} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <section className="mt-4 grid grid-cols-1 gap-4 text-sm">
                <section>
                  <h3 className="font-medium text-gray-700 mb-1">Project Duration</h3>
